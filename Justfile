...
release LEVEL="patch" NEW_VERSION="":
    ...
    open Cargo.toml | upsert packge.version $new_version | to toml | lines | insert 0 "# See more keys and their definitions at https://doc.rust-lang.org/cargo/reference/manifest.html" | to text | save _Cargo.toml; mv _Cargo.toml Cargo.toml; git add Cargo.toml
